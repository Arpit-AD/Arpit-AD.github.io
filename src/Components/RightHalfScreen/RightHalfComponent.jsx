...
function RightHalfScreenComponent({ Right }) {
	return (
		<div className="min-h-screen ml-auto xl:w-3/4 w-9/12 md:w-9/12 w-10/12 light-gradient-bg">
			{Right}
			<div className=" text-gray-500 w-fit text-lg tracking-widest fixed bottom-1/2 md:-right-12 -right-16 rotate-90 ">
				{" "}
				(+91) - 77019 61032
			</div>
            ...
            <span className='md:inline hidden '>RESUME</span>    <a href='https://bit.ly/ad-oct24_1' target="_blank" > <BsArrowUpRightCircleFill className='text-slate-600 hover:text-darkslate h-8 mx-1 w-10 '/> </a>
          </div> */}
		</div>
	);
}
