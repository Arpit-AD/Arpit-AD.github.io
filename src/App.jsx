		...
		<div className="">
			<Router>
				<Routes>
					...
					<Route
						path="/profile"
						element={<NotLandingPage Right={ProfileScreen} />}
					/>
					<Route
						path="/projects"
						element={<NotLandingPage Right={ProjectScreen} />}
					/>
					<Route
						path="/experience"
						element={<NotLandingPage Right={ExperienceScreen} />}
					/>
					<Route
						path="/contact"
						element={<NotLandingPage Right={ContactScreen} />}
					/>
				</Routes>
			</Router>
		</div>
